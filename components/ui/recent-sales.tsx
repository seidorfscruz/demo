  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center">
        ...
        <div className="ml-auto font-medium">453</div>
      </div>
      <div className="flex items-center">
        ...
        <div className="ml-auto font-medium">362</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
        ...
        <div className="ml-auto font-medium">267</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
        ...
        <div className="ml-auto font-medium">186</div>
      </div>
      <div className="flex items-center">
        <Avatar className="h-9 w-9">
